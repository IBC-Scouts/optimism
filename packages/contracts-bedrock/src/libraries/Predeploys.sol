...
library Predeploys {
    ...
    /// @notice Address of the IBCCrossDomainMessenger predeploy.
    address internal constant IBC_CROSS_DOMAIN_MESSENGER = 0x42000000000000000000000000000000000000E0;
